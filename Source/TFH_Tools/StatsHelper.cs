namespace TFH_Tools
{
    ...
    public static class StatsHelper
    {
        ...
        public static IEnumerable<KeyValuePair<StatDef, float>> GetStatsOfWorkType(Pawn pawn, WorkTypeDef worktype)
        {
            ...
            {
                case "Doctor":
                    yield return new KeyValuePair<StatDef, float>(StatDefOf.MedicalTendSpeed, 1f);
                    yield return new KeyValuePair<StatDef, float>(StatDefOf.SurgerySuccessChanceFactor, 1f);
                    yield return new KeyValuePair<StatDef, float>(StatDefOf.MedicalTendQuality, 1f);
                    yield return new KeyValuePair<StatDef, float>(StatDefOf.MedicalSurgerySuccessChance, 0.5f);
                    yield break;
                ...
                case "Warden":
                    ...
                    yield return new KeyValuePair<StatDef, float>(StatDefOf.SellPriceFactor, 0.2f);
