namespace TFH_Tools
{
    ...
    public class Designator_PutInToolbeltSlot : Designator
    {
        ...
        {
            if (!cell.InBounds(base.Map) || cell.Fogged(this.Map) || cell.ContainsStaticFire(this.Map))
            {
                return false;
            }
        ...
        protected override void FinalizeDesignationSucceeded()
        {
            ...
            foreach (Thing thing in this.SlotsToolbeltComp.designatedThings)
            {
                ...
                this.SlotsToolbeltComp.Owner.Reserve(thing, job);
            }
            ...
            {
                this.SlotsToolbeltComp.Owner.jobs.TryTakeOrderedJob(job);
            }
