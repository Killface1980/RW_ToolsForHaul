namespace TFH_VehicleBase.Recipes
{
    ...
    public class Recipe_InstallArtificialVehiclePart : Recipe_VehicleSurgery
    {
        [DebuggerHidden]
        ...
        public override void ApplyOnPawn(Pawn pawn, BodyPartRecord part, Pawn billDoer, List<Thing> ingredients, Bill bill)
        {
            ...
            {
                VehicleRecipesUtility.RestorePartAndSpawnAllPreviousParts(pawn, part, pawn.Position, pawn.Map);
            }
            else
            {
