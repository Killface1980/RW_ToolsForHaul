namespace TFH_VehicleBase.JobDrivers
{
    ...
    public class JobDriver_MountAndDraft : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            scatter.initAction = () =>
                {
                    List<Thing> thingsHere = this.pawn.Map.thingGrid.ThingsListAt(this.pawn.Position);
                    ...
                    {
                        IntVec3 freeCell = CellFinder.RandomClosewalkCellNear(this.pawn.Position, this.pawn.Map, 2);
