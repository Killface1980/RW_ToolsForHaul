...
namespace BuildProductive.Injection
{
    public class HookInjector
    {
        ...
        public HookInjector()
        {
            ...
            {
                _logger.LogError("No memory allocated, injector disabled.", null);
                return;
            }
        ...
        public void Inject(Type sourceType, string sourceName, Type targetType, string targetName = "")
        {
            ...
            {
                _logger.LogError("Source method {0}.{1} not found", sourceType.Name+ sourceName);
                return;
            }
        ...
        public void Inject(Type sourceType, MethodInfo sourceMethod, Type targetType, string targetName = "")
        {
            ...
            {
                _logger.LogError("Target method {0}.{1} not found", targetType.Name+ targetName);
                return;
            }
        ...
        void PatchAll()
        {
            ...
            _isInitialized = true;
            _logger.Log("Processed {0} methods.", _patches.Count);
        }
